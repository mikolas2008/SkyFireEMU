...
-- 34864, 34916(x1) Gilneas City Guard in phase 1
DELETE FROM `creature` WHERE `id` = 34864;
DELETE FROM `creature` WHERE `id` = 34916 AND phaseMask = 1 AND `map` = 638; -- guard protecting gate
INSERT INTO `creature` VALUES (@, 34864, 638, 1, 1, 0, 34916, -1459.31, 1400.08, 35.556, 3.79426, 300, 0, 0, 69, 79, 0, 0, 0, 0, 0);
INSERT INTO `creature` VALUES (@, 34864, 638, 1, 1, 0, 34916, -1431.72, 1349.03, 35.5545, 1.94936, 300, 0, 0, 69, 79, 0, 0, 0, 0, 0);
...
INSERT INTO `creature` VALUES (@, 34916, 638, 1, 1, 29466, 34916, -1440.89, 1354.19, 35.556, 1.33675, 5000, 5, 0, 84000, 0, 0, 1, 0, 0, 0); -- guard protecting gate

-- 34916 Gilneas City Guard in phase 2+4(=6)
DELETE FROM `creature` WHERE `id` = 34916 AND phaseMask <> 1 AND `map` = 638;
...
INSERT INTO `creature` VALUES (@, 44086, 638, 1, 7, 0, 0, -1437.86, 1354.48, 35.5545, 5.24411, 600, 0, 0, 42, 0, 0, 0, 0, 0, 0);
INSERT INTO `creature` VALUES (@, 44086, 638, 1, 7, 0, 0, -1432.97, 1356.84, 35.5545, 4.85219, 600, 0, 0, 42, 0, 0, 0, 0, 0, 0);
INSERT INTO `creature` VALUES (@, 44086, 638, 1, 7, 0, 0, -1429.58, 1357.67, 35.5545, 4.47756, 600, 0, 0, 42, 0, 0, 0, 0, 0, 0);
INSERT INTO `creature` VALUES (@, 44086, 638, 1, 7, 0, 0, -1425.92, 1358.6, 35.5545, 4.18068, 600, 0, 0, 42, 0, 0, 0, 0, 0, 0);
INSERT INTO `creature` VALUES (@, 44086, 638, 1, 7, 0, 0, -1435.62, 1356.34, 35.5545, 5.16635, 600, 0, 0, 42, 0, 0, 0, 0, 0, 0);
INSERT INTO `creature` VALUES (@, 44086, 638, 1, 7, 0, 0, -1430.93, 1360.55, 35.5545, 4.57102, 600, 0, 0, 42, 0, 0, 0, 0, 0, 0);
INSERT INTO `creature` VALUES (@, 44086, 638, 1, 7, 0, 0, -1434.45, 1362.22, 35.5545, 4.85769, 600, 0, 0, 42, 0, 0, 0, 0, 0, 0);
INSERT INTO `creature` VALUES (@, 44086, 638, 1, 7, 0, 0, -1439.85, 1359.66, 35.5545, 5.43653, 600, 0, 0, 42, 0, 0, 0, 0, 0, 0);
INSERT INTO `creature` VALUES (@, 44086, 638, 1, 7, 0, 0, -1426.98, 1361.93, 35.5545, 4.46106, 600, 0, 0, 42, 0, 0, 0, 0, 0, 0);
INSERT INTO `creature` VALUES (@, 44086, 638, 1, 7, 0, 0, -1436.58, 1360.1, 35.5545, 5.15614, 600, 0, 0, 42, 0, 0, 0, 0, 0, 0);
